...
int main () {
  ...
  vll cumulative_one;
  vll cumulative_two;
  cumulative_one.push_back(0);
  cumulative_two.push_back(0);

  rep(i, n) {
    ll c, p; cin >> c >> p;
    if (c == 1) {
      cumulative_one.push_back(cumulative_one[i] + p);
      cumulative_two.push_back(cumulative_two[i]);
    } else {

      cumulative_two.push_back(cumulative_two[i] + p);
      cumulative_one.push_back(cumulative_one[i]);
    }
  }
  ...
  rep(i, q) {
    ll l, r; cin >> l >> r;
    cout << cumulative_one[r] - cumulative_one[l - 1] << " ";
    cout << cumulative_two[r] - cumulative_two[l - 1] << endl;
